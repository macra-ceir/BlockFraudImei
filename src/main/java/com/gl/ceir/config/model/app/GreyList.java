...
@Setter
@ToString
public class GreyList extends GenericList implements Serializable {
    ...
    public GreyList(String actualImei, String imsi, String msisdn, String txnId, int operator_id, String operatorName, String userType, String userId, LocalDateTime expiryDate) {
